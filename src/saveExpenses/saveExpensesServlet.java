...
public class saveExpensesServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "SELECT SUM(SPrise) FROM stock WHERE Rdate between '"+sqlDate1+"' and '"+sqlDate2+"'";
			
			String sql1 = "SELECT SUM(EmonthlySalary) FROM payments WHERE EpayDay between '"+sqlDate1+"' and '"+sqlDate2+"'";
